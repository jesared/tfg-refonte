  ...
  return (
    <div ref={menuRef} className="relative inline-flex">
      <button
        ...
        className="cursor-pointer inline-flex h-9 w-9 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
      >
      ...
      {isOpen && (
        <div
          role="menu"
          className="absolute right-0 top-full z-10 mt-2 flex flex-col rounded-md border border-border bg-popover p-1.5 shadow-lg"
        >
          {canValidate && (

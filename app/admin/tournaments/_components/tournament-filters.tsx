...
function firstOrEmpty(value: string | string[] | undefined) {
...
export function TournamentFilters() {
  ...
  const initialValues = useMemo(
    () => ({
      q: firstOrEmpty(searchParams.get("q") ?? undefined),
      status: firstOrEmpty(searchParams.get("status") ?? undefined) || "all",
      tour: firstOrEmpty(searchParams.get("tour") ?? undefined),
      from: firstOrEmpty(searchParams.get("from") ?? undefined),
      to: firstOrEmpty(searchParams.get("to") ?? undefined),
    }),
    [searchParams],
  );

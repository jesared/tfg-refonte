  ...
  return (
    <main className="min-h-screen bg-card px-6 py-16 text-foreground">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-12">
        ...
        <section className="grid gap-6 rounded-3xl border border-border bg-muted/50 p-8 shadow-sm">
        ...
        <section className="grid gap-8 rounded-3xl border border-border bg-card p-8 shadow-sm lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="overflow-hidden rounded-3xl border border-border bg-muted/50">
            <img
        ...
        <section className="space-y-6">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-muted/50">
